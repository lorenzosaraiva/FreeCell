...
const char RESET_LISTA_CMD         [ ] = "=resetteste"     ;
 const char CRIAR_LISTA_CMD         [ ] = "=criarlista"     ;
const char DESTRUIR_LISTA_CMD      [ ] = "=destruirlista"  ;
 const char ESVAZIAR_LISTA_CMD      [ ] = "=esvaziarlista"  ;
 const char INS_ELEM_ANTES_CMD      [ ] = "=inselemantes"   ;
 const char INS_ELEM_APOS_CMD       [ ] = "=inselemapos"    ;
 const char OBTER_VALOR_CMD         [ ] = "=obtervalorelem" ;
 const char EXC_ELEM_CMD            [ ] = "=excluirelem"    ;
const char IR_INICIO_CMD           [ ] = "=irinicio"       ;
 const char IR_FIM_CMD              [ ] = "=irfinal"        ;
 const char AVANCAR_ELEM_CMD        [ ] = "=avancarelem"    ;
 const char PEGA_NUMERO_ELEMENTOS_CMD      [ ] = "=peganumeroelementos" ;
 const char PROCURAR_VALOR_CMD      [ ]      = "=procuravalor";
...
***********************************************************************/
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* LIS  &Avançar elemento */
		 ...
		 else if ( strcmp(ComandoTeste, PEGA_NUMERO_ELEMENTOS_CMD) == 0)
		 {
			 numLidos = LER_LerParametros( "i", &inxLista);
              ...
              || ( ! ValidarInxLista( inxLista , NAO_VAZIO )) )
            {
			 ...
			 pegaNumeroElementos(vtListas[inxLista]);
		 ...
		 else if ( strcmp(ComandoTeste, PROCURAR_VALOR_CMD) == 0)
		 {
			...
			CondRet = LIS_ProcurarValor(vtListas[inxLista], pDado);
				...
				return TST_CompararInt(CondRetEsp, CondRet, "Condicao de retorno invalida ao obter elemento") ;
			...
			if(LIS_VerificarCabeca( vtListas[ inxLista ] ) == LIS_CondRetOK){
				return TST_CondRetOK;
			}
